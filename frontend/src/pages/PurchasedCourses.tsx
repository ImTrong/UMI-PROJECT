  ...
  return (
    <div className="min-h-screen bg-slate-50/50 pt-8 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative mb-12 p-8 rounded-3xl overflow-hidden bg-gradient-to-br from-primary-900 to-primary-700 shadow-sm overflow-hidden group">
        ...
        {courses.length === 0 ? (
          <div className="bg-white rounded-3xl p-16 text-center shadow-sm border border-slate-100">
            ...
            <h2 className="text-2xl font-bold text-slate-900 mb-3">Thư viện của bạn đang trống</h2>
            <p className="text-slate-500 mb-8 max-w-md mx-auto">Bạn chưa đăng ký khóa học nào. Hãy khám phá và mua khóa học để bắt đầu hành trình học tập.</p>
            <Link 
              to="/courses" 
              className="inline-flex items-center justify-center px-8 py-3.5 text-base font-semibold text-white bg-primary-600 rounded-xl hover:bg-primary-700 shadow-sm shadow-primary-600/30 transition-all hover:-translate-y-0.5"
            >
            ...
            {courses.map((course) => {
              ...
              return (
                <Link
                  ...
                  className="group relative bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-sm transition-all duration-300 border border-slate-100 flex flex-col hover:-translate-y-1"
                >
                  {/* Thumbnail Container */}
                  <div className="relative h-48 overflow-hidden bg-slate-100">
                    {course.details?.thumbnail ? (
                      ...
                      <div className="w-full h-full flex flex-col items-center justify-center text-slate-300 bg-gradient-to-br from-gray-50 to-gray-100">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 bg-black/20 transition-opacity duration-300">
                      <div className="bg-white/90 p-4 rounded-full shadow-sm transform scale-75 group-hover:scale-100 transition-all duration-300">
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    <h3 className="font-bold text-slate-900 leading-tight mb-2 line-clamp-2 min-h-[2.5rem] group-hover:text-primary-600 transition-colors">
                      {course.courseTitle}
                    </h3>
                    ...
                    <div className="flex items-center text-xs text-slate-500 mb-4 space-x-3">
                      ...
                      {course.details?.instructorId && (
                        <div className="px-1.5 border-l border-slate-100">
                          {course.details.instructorId}
                        </div>
                      )}
                    </div>
                    ...
                    <div className="mt-auto">
                      ...
                      <div className="flex items-center justify-between text-xs font-medium mb-2">
                        <span className={isCompleted ? "text-green-600 flex items-center" : "text-slate-500"}>
                          {isCompleted ? (
                      ...
                      {/* Bottom Meta */}
                      <div className="flex items-center justify-between mt-4 text-[11px] text-slate-400 font-medium uppercase tracking-wide">
                        <div className="flex items-center">
